            ...
            public void onClick(View view) {
                if(view.getId()== R.id.sonido2){
                    if(mp.isPlaying()){
                        ...
                        Toast.makeText(MainActivity9.this,"Pausa",Toast.LENGTH_SHORT).show();
                    }else{
                        mp.start();
                        play.setBackgroundResource(R.drawable.play);
                        Toast.makeText(MainActivity9.this,"Play",Toast.LENGTH_SHORT).show();
